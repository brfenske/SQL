...
/****** Object:  StoredProcedure [dbo].[GenerateUser]    Script Date: 11/13/2013 13:02:53 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[GenerateUser]') AND type in (N'P', N'PC'))
